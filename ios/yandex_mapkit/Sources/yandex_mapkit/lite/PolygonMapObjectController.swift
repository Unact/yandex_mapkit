...
class PolygonMapObjectController: NSObject, MapObjectController, YMKMapObjectTapListener {
  ...
  public required init(
    ...
    let polygon = parent.addPolygon(with: UtilsLite.polygonFromJson(params["polygon"] as! [String: Any]))
  ...
  public func update(_ params: [String: Any]) {
    polygon.geometry = UtilsLite.polygonFromJson(params["polygon"] as! [String: Any])
    ...
    polygon.strokeColor = UtilsLite.uiColor(fromInt: (params["strokeColor"] as! NSNumber).int64Value)
    polygon.strokeWidth = (params["strokeWidth"] as! NSNumber).floatValue
    polygon.fillColor = UtilsLite.uiColor(fromInt: (params["fillColor"] as! NSNumber).int64Value)
